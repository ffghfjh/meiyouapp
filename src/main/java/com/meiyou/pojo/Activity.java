...
public class Activity {
    ...
    public Activity(Integer id, Date createTime, Date updateTime, Integer publishId, String imgsUrl, String content, Integer readNum, Integer likeNum, Integer commontNum, User user, Boolean boolClose, Integer fileType) {
        this.id = id;
